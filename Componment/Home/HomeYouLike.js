...
export default class HomeYouLike extends Component<Props> {
             ...
             <View style={styles.listViewStyle}>
                 ...
                 <View style={styles.rightViewStyle}>
                    <View style={styles.rightTopViewStyle}>
                      <Text style = {{color:'#666666',fontSize:16,fontWeight:'bold'}}>{rowData.title}</Text>
                      <Text style = {{color:'#999999',fontSize:12,}}>{rowData.topRightInfo}</Text>
                    </View>
                    ...
                    <View  style={styles.rightBottomViewStyle}>
                        ...
                        <Text style = {{color:'#777777',fontSize:12,}}>{rowData.bottomRightInfo}</Text>
                    </View>
                 </View>
             </View>
          </TouchableOpacity>
